...
resource "vault_generic_endpoint" "config_cluster" {
...
resource "vault_generic_endpoint" "config_urls" {
  depends_on           = [vault_mount.pki, vault_generic_endpoint.config_cluster]
...
# Tune mount
resource "vault_generic_endpoint" "tune" {
  depends_on           = [vault_mount.pki]
